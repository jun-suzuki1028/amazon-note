...
[ペルソナ属性]の使用環境を踏まえ、以下の評価軸で各製品を分析しました（優先順位順）：
...
**価格帯について**：[投資対効果の考え方]を重視し、[下限価格]円〜[上限価格]円の価格帯を中心に選定。[価値提供]を優先し、[期待される効果]が期待できる製品を厳選しています。

これらの基準に基づき、[使用シーン]での実用性を最優先に製品を評価・ランキングしています。
...
- 用途別最適解は明確に区別して提示
- Q&Aは簡潔に、実用性を重視
- **選定基準セクションは必須**：優先順位順で5つの評価軸を明示
- **価格帯の明示**：ターゲット価格帯と投資対効果の考え方を記載
- **注意点での価格言及は避ける**：経営者向けなど高所得層向けの場合は「価格が高め」等の表現は不要
